...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20210909081449_AddApplicantToFileInfoOneToMany")]
    partial class AddApplicantToFileInfoOneToMany
    {
            ...
            modelBuilder.Entity("Domain.Entities.VacancyCandidate", b =>
                {
                    ...
                    b.HasIndex("CvFileInfoId")
                        .IsUnique()
                        .HasFilter("[CvFileInfoId] IS NOT NULL");
            ...
            modelBuilder.Entity("Domain.Entities.VacancyCandidate", b =>
                {
                    ...
                    b.HasOne("Domain.Entities.FileInfo", "CvFileInfo")
                        .WithOne("VacancyCandidate")
                        .HasForeignKey("Domain.Entities.VacancyCandidate", "CvFileInfoId")
